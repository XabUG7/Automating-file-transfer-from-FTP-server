# Automating-file-transfer-from-FTP-server
...
and stores them temporarily in a selected files. Then it transfers all the files to a selected directory using shutil. 
